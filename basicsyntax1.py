"""
Progam 1 of Ynon Perek's NonTrivial Python
Asks the user for an integer, and returns the sum of the digits in that number
"""
import sys
...
def utility(argv):
    """
    interprets argv to decide to run testing or the main program
    """
    if(len(argv) == 1):
        running = True
